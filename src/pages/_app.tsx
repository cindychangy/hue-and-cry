...
const App = ({ Component, pageProps }: AppProps) => {
  ...
  return (
    ...
    <Head>
      ...
      <link rel="icon" type="image/png" sizes="32x32" href={`${process.env.NEXT_PUBLIC_MEDIA_URL}/favicon-32x32-1.png`} />
      <link rel="icon" type="image/png" sizes="16x16" href={`${process.env.NEXT_PUBLIC_MEDIA_URL}/favicon-16x16-1.png`} />
