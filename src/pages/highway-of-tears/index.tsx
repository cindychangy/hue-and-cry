  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href={`${process.env.NEXT_PUBLIC_BASE_URL}/highway-of-tears`} />
        ...
        <meta property="og:url" content={`${process.env.NEXT_PUBLIC_BASE_URL}/highway-of-tears`} />
